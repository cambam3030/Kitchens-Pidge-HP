        ...
        switch(choice) {
            case "C"://The cake breaks your teeth.
                console.println("\n You took a rather large bite of cake. Well,"
                        + "\n you tried to. A visit to Madame Pomfrey may be in "
                        + "\n order to fix your now cracked teeth. You hid the "
                        + "\n rest in  your napkin so as not to hurt Hagrid's feelings.");
                break;
            case "T"://Toffy glues your mouth shut
                console.println("\n You enjoyed a nice bit of Hagrid's toffy. Until "
                        ...
                        + "\n table to help unglue your mouth.");
            case "F"://Fang
